...
async function createTodo() {
    ...
    const isCompleted = document.querySelector('input[name="isCompleted"]:checked').value;
    if (!todoText) {
...
async function updateTodo(id) {
    ...
    if (todo) {
        ...
        const updateIsCompletedYes = document.getElementById('updateIsCompletedYes');
        ...
        saveUpdate.addEventListener('click', async () => {
            ...
            const isCompleted = document.querySelector('input[name="updateIsCompleted"]:checked').value;
